;メッセージレイヤの定義
		...
		[position width=880 height=170 top=420 left=40 ]


		
			[position page=fore margint=20 marginl=30 marginr=30 marginb=20 vertical=false opacity="180" radius="0" color="0x000000" ]
		...
		;クリック待ちボタンについて
		[glyph fix="true" left="459" top="580" line="nextpage.png" anim="" ]
		...
		[position layer="message1" width=880 height=170 top=420 left=40 ]
