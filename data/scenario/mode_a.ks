...
[tb_show_message_window  ]
[tb_start_text mode=3 ]
ノーマルレベルは 数字の部分も漢字の部分も含めた[r]
[_tb_end_text]

[tb_start_text mode=1 ]
正確な度数を当てないと正解にならないよ！[p]
[_tb_end_text]
...
[call  storage="second_alphabet_hyouji.ks"  target="*0"  ]
[tb_start_tyrano_code]
;↑second_alphabet_huouji内はsecond_noteを参照。変数操作は無し。
[_tb_end_tyrano_code]

[call  storage="second_acc_select.ks"  target="*0"  ]
[tb_start_tyrano_code]
...
[call  storage="1oct_ue_no_hyouji.ks"  target="*0"  ]
[tb_start_tyrano_code]
...
[call  storage="interval_check.ks"  target="*0"  ]
[tb_start_tyrano_code]
...
[call  storage="interval_select.ks"  target="*0"  ]
[tb_start_tyrano_code]
