...
[jump  storage="first_alphabet_hyouji.ks"  target="*f"  cond="f.first_note==43"  ]
[jump  storage="first_alphabet_hyouji.ks"  target="*g"  cond="f.first_note==53"  ]
[jump  storage="first_alphabet_hyouji.ks"  target="*a"  cond="f.first_note==63"  ]
[jump  storage="first_alphabet_hyouji.ks"  target="*b"  cond="f.first_note==73"  ]
