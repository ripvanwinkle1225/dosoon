...
[jump  storage="mode_b.ks"  target="*normal_mode_on"  ]
...
[glink  color="btn_02_black"  text="タイトルに戻る！"  x="215"  y="500"  size="40"  target="*return_to_title"  width="530"  height="95"  _clickable_img=""  storage="mode_b.ks"  ]
[s  ]
*easy
...
[call  storage="interval_select_b.ks"  target=""  ]
[tb_start_tyrano_code]
...
[call  storage="note_check.ks"  target=""  ]
[tb_start_tyrano_code]
...
[tb_hide_message_window  ]
[call  storage="note_select_b.ks"  target=""  ]
[tb_start_tyrano_code]
...
[call  storage="second_alphabet_hyouji_b.ks"  target=""  ]
[tb_start_tyrano_code]
;↑second_alphabet_huouji_b内はsecond_noteを参照。変数操作は無し。
[_tb_end_tyrano_code]

[call  storage="second_acc_select_b.ks"  target=""  ]
[tb_start_tyrano_code]
...
[call  storage="1oct_ue_no_hyouji_b.ks"  target=""  ]
[tb_start_tyrano_code]
...
[glink  color="btn_02_black"  storage="mode_b.ks"  size="40"  text="タイトルに戻る"  x="250"  y="441"  width="330"  height="90"  _clickable_img=""  target="*return_to_title"  ]
[s  ]
*return_to_title
